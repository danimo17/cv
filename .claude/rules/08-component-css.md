...
d'`AppText`** (`app-text.css`, decisió 026): cap altre CSS de component la declara; els elements de text són
`<AppText>` i el CSS del component només posa layout/espai.
