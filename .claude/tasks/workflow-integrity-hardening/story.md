...
into the project on 2026-09-25 — not queued here, it's live. Rule numbers below start at 17.
...
2. **Synchronized change — no orphaned references.** When an artifact's public surface changes (removed/
   ...
   **and** e2e). Concretely:
   - New rule 18 (or fold into 07 — decide when writing the contract) stating this explicitly.
