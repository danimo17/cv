...
| `.custom-pagination` | — (`<nav>` que s'amaga sol si `pageCount <= 1`, decisió 034)                                                                                                                                                                                                                                                                                                     | `__status` (`tabular-nums`)                                                                                                                                                                                                                                                                                                                                                                                 | `flex items-center justify-center gap-3`; anterior/següent són `CustomButton` ghost només-icona                                                                             |
...
| `.meme-recent-searches` | —                                                                    | `__list` (`flex flex-wrap gap-2`); termes com a `CustomButton` ghost neutral                                                                                                                                                                                  |
