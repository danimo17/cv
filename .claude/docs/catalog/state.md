...
|              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Estat        | `query: string` (retallada), `limit: number` (`DEFAULT_GIPHY_LIMIT = 12`), `offset: number` (pàgina actual, 0 = primera), `items: Meme[]` (computed de `data.items`), `total: number` (computed de `data.total`, `0` per defecte), `status: AsyncDataRequestStatus`, `error`, `errorKey: string` (computed: `''` si no hi ha error; si no, `giphyService.toUserErrorKey(error)`), `history: string[]` (últims 5 termes cercats, més recent primer, sense duplicats — decisió 034; **no** és el mateix concepte que `hero.history`) |
| Accions      | `search(q)` → retalla, ignora buides, reinicia `offset` a `0`, actualitza `history` (dedupe + `slice(0,5)`), `execute()`; `goToOffset(newOffset)` → canvia `offset` (mateixa `query`) i `execute()`, sense tocar `history`                                                                                                                                                                                                                                                                                                         |
| Persistència | cap                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Consumidors  | `pages/meme.vue` (`items`, `status`, `errorKey`, `query`, `total`, `offset`, `history`, `search`, `goToOffset`)                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Test         | `tests/unit/stores/giphy.spec.ts` (`registerEndpoint` que simula 200/400/503 segons `q`; cobreix `history` dedupe/màxim 5/ordre)                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| Mètode           | Signatura                                                                                                               | Fa                                                                                                                         |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `createSearch`   | `(query: Ref<string>, limit: Ref<number> \| number, offset: Ref<number> \| number = 0) → useFetch<GiphySearchResponse>` | defineix la petició a la ruta de cerca (inclòs `offset`, decisió 034) amb `immediate: false`, `watch: false`; no l'executa |
